...
// }
//   let count = 0;
//   for (let i = 0; i < str.length; i++ && count < num) {
...
//         if (parseInt(arr[i][j]) || parseInt(arr[i][j]) === 0) {
//           result.push(arr[i]);
//           break;
//         }
//       }
...
// console.log(strContainingNumbers(["1a", "a2", "0x b", "b"]));
// console.log(strContainingNumbers(["this is a test", "test1"]));
// console.log(strContainingNumbers(["1", "a", " ", "b"]));
// console.log(
//   strContainingNumbers(["this IS", "10xYZ", "xy2K77", "Z1K2W0", "xYz"])
// );
// console.log(strContainingNumbers(["-/>", "10bc", "abc "]));
...
//   let letters = {}
//   for (let i = 0; i < arr.length;i++) {
//     return mappedArr = (`${arr[0]}: ${arr[0].toUpperCase} `)
//   }
// }
// mapping(["p", "s"])